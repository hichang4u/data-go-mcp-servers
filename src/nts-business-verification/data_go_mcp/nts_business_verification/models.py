...
class BusinessInfo(BaseModel):
    ...
    p_nm2: Optional[str] = Field(default=None, description="대표자성명2 (외국인 한글명)")
    b_nm: Optional[str] = Field(default=None, description="상호")
    corp_no: Optional[str] = Field(default=None, description="법인등록번호 (13자리)")
    b_sector: Optional[str] = Field(default=None, description="주업태명")
    b_type: Optional[str] = Field(default=None, description="주종목명")
    b_adr: Optional[str] = Field(default=None, description="사업장주소")
...
class ValidateResponse(BaseModel):
    ...
    valid_cnt: Optional[int] = Field(default=0, description="유효 건수")
...
class ErrorResponse(BaseModel):
    ...
    message: Optional[str] = Field(default=None, description="오류 메시지")
