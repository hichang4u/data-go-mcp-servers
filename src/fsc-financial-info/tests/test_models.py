...
class TestSummaryFinancialStatement:
    ...
    def test_summary_statement_optional_fields(self):
        ...
        statement = SummaryFinancialStatement(crno="1234567890123", biz_year="2023")
    ...
    def test_decimal_json_encoding(self):
        ...
        statement = SummaryFinancialStatement(
            crno="1234567890123", biz_year="2023", enp_sale_amt=Decimal("1000000000.50")
        )
...
class TestAPIResponses:
    ...
    def test_summary_financial_response(self):
        ...
        response = SummaryFinancialResponse(
            ...
            page_no=1,
            total_count=1,
            items=[SummaryFinancialStatement(crno="1234567890123", biz_year="2023")],
        )
...
def test_decimal_serializes_as_number_in_json():
    ...
    item = BalanceSheetItem(
        crno="1234567890123", biz_year="2023", crtm_acit_amt=Decimal("12.5")
    )
